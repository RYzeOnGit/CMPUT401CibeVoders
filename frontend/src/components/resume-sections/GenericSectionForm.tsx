          ...
          <div className="space-y-4">
              ...
              <div key={index} className="bg-gray-800 rounded-lg border border-gray-700 p-4">
                ...
                <div className="mb-3">
                  ...
                  <textarea
                    ...
                    className="w-full px-3 py-2 border border-gray-600 rounded bg-gray-700 text-gray-100 text-sm resize-y min-h-[100px] focus:outline-none focus:ring-2 focus:ring-purple-500"
            ...
            <button
              onClick={() => {
                updateData({
                  type: 'bullet-points',
                  items: [...bulletData.items, { description: '' }]
                });
              }}
        ...
        {isEditingName ? (
          <div className="flex items-center gap-2 flex-1">
            <input
              ...
              className="flex-1 px-3 py-1 border border-gray-600 rounded bg-gray-800 text-gray-100 text-sm font-semibold uppercase tracking-wider text-center focus:outline-none focus:ring-2 focus:ring-purple-500"
              autoFocus
            />
            <button
          ...
          <>
            <label className="text-sm font-semibold text-purple-400 uppercase tracking-wider text-center">
              {section.name}
            </label>
            <button
              onClick={onStartEditName}
              className="absolute right-0 p-1 text-gray-400 hover:text-gray-300"
