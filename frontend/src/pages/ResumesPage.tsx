...
import { FileText, ArrowLeft, Plus, Upload, X, Trash2, Copy, Download, ChevronLeft, ChevronRight, ZoomIn, ZoomOut, Maximize, Edit, Crown, Sparkles } from 'lucide-react';
...
function PDFViewer({ resume, onDelete, onCreateDerived, onSetMaster, onUnsetMaster, onApplyTemplate }: { resume: Resume; onDelete: () => void; onCreateDerived: () => void; onSetMaster: () => void; onUnsetMaster: () => void; onApplyTemplate: () => void }) {
